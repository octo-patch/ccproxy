...
`vertex_ai` / `vertex_ai_beta` / `perplexity_pro`; Anthropic-compatible forks like `deepseek`, `zai`,
and `minimax` use `type: anthropic`), and an optional `fingerprint_profile` (curl-cffi impersonate name,
