...
Covers the engagement rule: sidecar engages when ``Provider.fingerprint_profile``
is set; mitmproxy's native transport is used otherwise, regardless of whether
a shape file carries a captured fingerprint in its metadata.
"""
...
class TestNoopPaths:
    ...
    async def test_noop_when_fingerprint_profile_is_none(self) -> None:
        """Provider exists, fingerprint_profile=None — flow is untouched."""
