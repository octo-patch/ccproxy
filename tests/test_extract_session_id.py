...
class TestExtractSessionIdHook:
    ...
    def test_json_user_id_no_account_uuid(self) -> None:
        ...
        ctx = _make_ctx(body_metadata={"user_id": user_id})
        result = extract_session_id(ctx, {})
        assert _flow(result).metadata["ccproxy.session_id"] == "s1"
